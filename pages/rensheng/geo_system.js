...
const REGIONS = {
  ...
  '西陆联盟': {
    ...
    characters: [
      'Ιππότης(希庇安)',       // Αθάνατο的禁卫骑士
      'Αθάνατο(安布罗斯)',     // 伪神，"至高意志"
      'AT(Albert Palazzo)',     // 伪神，圣使教
      'Evangelium.福音',        // 伪神，济世者
      'Joschmitt.（约斯米特）', // 伪神，静谧织命者
      '瓦莉奥尔·阿亚奇',        // 伪神，漂泊的战斗者
      '卡芙涅',                  // 伪神，静谧织命者
      '维拉莉娅',                // 伪神，梦之圣殿
      '汉兹安索德',              // 伪神，长眠中，"手与刃"派系
  ...
  '自由联盟': {
    ...
    characters: [],
    geoConstraint: '自由联盟是独立者和流浪者的家园。这里的角色通常不属于任何官方组织，行动更加自由但也更加危险。目前暂无文档中明确归属此地的角色，但自由联盟居民以独立调查员、自由猎人为主，事件更加个人化和心理化。',
  },
};
