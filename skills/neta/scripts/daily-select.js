...
const ACTIVITY_ID = '5de4631f-11bc-479e-ac4b-f9445ceaa063';
...
async function main() {
  ...
  // 调用精选 API
  const reviewUrl = `https://api.talesofai.cn/v1/hashtag/${encodeURIComponent('伪人大本营之灯塔分院帽')}/stories/review/${REVIEW_UUID}`;
  const requestBody = {
