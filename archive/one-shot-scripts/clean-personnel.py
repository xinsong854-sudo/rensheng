...
# Clean up names - remove aliases and duplicates
cleaned_names = set()
for name in all_names:
    # Skip aliases (they're already added as real names)
    if name in aliases:
        continue
    # Skip obvious non-names
    if name in ['花坛', '积水池', '福利院', '空地', '地下室', '锅炉房', '公寓', '待登记住户', 
                '不提供住处', '室外区域', '永远的家', '槐安公寓', '茶居公寓', '西陆联盟', 
                '白墟之地', '错位花园', '非常电影院', '童话国', '手与剑之乡', '梦之圣庭', 
                '静谧织命者', '不提供住处', '复合实验室']:
        continue
